...
export function Chat({ assistant }: { assistant?: AssistantStatus }) {
  ...
  return (
    <section className="panel" aria-labelledby="chat-title">
      ...
      {/* People must know they are dealing with an AI system (EU AI Act,
          art. 50): said before the first question, not after an answer. */}
      <p className="muted">
        Answers are generated by an AI model and can be wrong: check them against the alerts and runbooks before
        acting.
      </p>
      {off && (
        <p className="notice">
